...
<button id="stationDelete" onclick="location.href='/admin/reviewDelete?review_no=${viewBoard.review_no }'">삭제</button>
...
<tr>
	<td class="active">글번호</td><td>${viewBoard.review_no }</td>
	<td class="active">작성일</td><td>${viewBoard.review_date }</td>
</tr>
<tr>
...
<tr>
	<td class="active" colspan="4">리뷰 내용</td>
</tr>
<tr>
	<td colspan="4">${viewBoard.review_content }</td>
</tr>
</table>
</div>
...
<button id="backList" onclick="location.href='/admin/stationReviewList'">목록</button>
